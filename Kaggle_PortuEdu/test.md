...
결론적으로, 포루투갈 학생들의 음주는 나이의 증가와 강한 연관성을 가지고 있으며, 성별이 남자이고, 낙제과목이 많아질수록, 가족간 관계가
안 좋을수록 음주량이 증가한다. 부모의 결합상태는 큰 영향이 없으며, 40점 이상의 연간성적 범주에서는 성적과 음주량이 반비례, 
20점 이하에서는 성적과 음주량이 비례, 20점과 40점 사이에서는 변화가 없다.
